      ...
      <div class="custom-col-achi">
        <div class="achi-box hoverable">
          ...
          <div class="achi-event-name">
            <span class="colored achi-event-name"><strong>BAJA SAE LOUISVILLE, <span class="achi-date">2020</span></strong></span>
          </div>
          <div class="achi-desc">
            <ul>
              <li>4th Overall Internationally</li>
              <li>6th in Design Presentation</li>
              <li>8th in Cost Event</li>
              <li>12th in Sales Presentation</li>
              <li>Team Jaabaz has become one of the few International teams to present a FOUR WHEEL DRIVE ATV for the first time ever.</li>
              <li>We are the 1st amongst all Indian teams to achieve such a rank for a FOUR WHEEL DRIVE ATV.</li>
            </ul>
          </div>
        </div>
        <div class="achi-box hoverable">
